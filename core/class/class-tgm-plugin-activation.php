...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	if ( ! function_exists( '\annonces\load_tgm_plugin_activation' ) ) {
		/**
...
if ( ! function_exists( '\annonces\tgmpa' ) ) {
	/**
		...
		public function process_bulk_actions() {
			...
			if ( 'tgmpa-bulk-activate' === $this->current_action() ) {
				...
				if ( is_wp_error( $activate ) ) {
					...
					$plugin_names = array_map( array( '\annonces\TGMPA_Utils', 'wrap_in_strong' ), $plugin_names );
...
if ( ! function_exists( '\annonces\tgmpa_load_bulk_installer' ) ) {
	/**
	 * Load bulk installer
	 */
...
if ( ! class_exists( '\annonces\TGMPA_Utils' ) ) {
